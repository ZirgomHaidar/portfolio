...
export const ProjectList: ProjectType[] = [
    ...
    },
    {
        ...
        tools: ["Python", "fastapi[standard]>=0.112.0", "requests", "pydantic", "apscheduler",],
    ...
    },
    {
        ...
        desc: "Evolution X aims to provide users with a Pixel-like feel at first glance, with additional features at their disposal!",
